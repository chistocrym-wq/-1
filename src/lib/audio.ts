export async function blobToWav(blob: Blob): Promise<Blob> {
  ...
  try {
    ...
    writeString(0, 'RIFF'); view.setUint32(4, 36 + targetLength * 2, true); writeString(8, 'WAVE'); writeString(12, 'fmt ');
    view.setUint32(16, 16, true); view.setUint16(20, 1, true); view.setUint16(22, 1, true); view.setUint32(24, targetRate, true);
    view.setUint32(28, targetRate * 2, true); view.setUint16(32, 2, true); view.setUint16(34, 16, true); writeString(36, 'data'); view.setUint32(40, targetLength * 2, true);
