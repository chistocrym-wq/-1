...
const WORDS: Record<string,string> = {
  sie:'Вы / они', möchten:'хотеть', einen:'один / какой-то', eine:'одна / какую-то', ein:'один / какой-то', der:'артикль', die:'артикль', das:'артикль', den:'артикль', dem:'артикль', ihr:'ваш / ваша', ihre:'ваша / их', ihrer:'вашей / их', ihnen:'им', ich:'я', wir:'мы', mein:'мой',
  ...
  sportverein:'спортивный клуб', warum:'почему', welchen:'какой / который', welchem:'какому', welcher:'какая / которая', tagen:'дни', tage:'дни', preis:'цена',
  freund:'друг', freundin:'подруга', freunde:'друзья', freunden:'друзьям', karte:'открытка', wann:'когда', kommen:'приходить / приезжать', kommt:'приходит / приезжает', wie:'как', reisen:'путешествовать / ехать', zusammen:'вместе', machen:'делать', was:'что',
  tochter:'дочь', sohn:'сын', kinder:'дети', kind:'ребёнок', krank:'больной', schule:'школа', fehlt:'отсутствует', fehlen:'отсутствовать', vom:'с / от', bis:'до', märz:'март', januar:'январь', fragen:'спрашивать', hausaufgaben:'домашние задания',
  ...
  notiz:'записка', kollegin:'коллега', kollege:'коллега', morgen:'завтра', später:'позже', heute:'сегодня', arbeiten:'работать', arbeitet:'работает', länger:'дольше', juni:'июнь', nürnberg:'Нюрнберг', party:'вечеринка', freitag:'пятница', kleine:'маленькая', laden:'приглашать', einladen:'приглашать', beginnt:'начинается', beginnen:'начинаться', gäste:'гости', mitbringen:'приносить с собой',
