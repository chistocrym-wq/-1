...
const WORDS: Record<string,string> = {
  sie:'Вы / они', sie:'Вы / они',
  möchten:'хотеть', einen:'один / какой-то', eine:'одна / какую-то', ein:'один / какой-то', der:'артикль', die:'артикль', das:'артикль', den:'артикль', dem:'артикль', ihr:'ваш / ваша', ihre:'ваша / их', ihrer:'вашей / их', Ihnen:'вам', ihnen:'им', ich:'я', wir:'мы', mein:'мой',
